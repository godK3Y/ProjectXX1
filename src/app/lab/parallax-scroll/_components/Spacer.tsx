/**
 * Empty scroll runway between parallax sections; the label doubles as the
 * title of the section below it.
 *
 * The effects animate across the window between "element enters the viewport"
